...
namespace Pawfect_Pet_Adoption_App_API.Builders
{
    ...
    public class AnimalBuilder : BaseBuilder<AnimalDto, Animal>
    {
        ...
        public AnimalBuilder(BreedLookup breedLookup, IBreedService breedService,
                             ShelterLookup shelterLookup, IShelterService shelterService
                            , AnimalTypeLookup animalTypeLookup, IAnimalTypeService animalTypeService)
        {
        ...
        private async Task<Dictionary<string, BreedDto>> CollectBreeds(List<Animal> animals, List<string> breedFields)
        {
            ...
            // Κατασκευή των dtos
            List<BreedDto> breedDtos = (await _breedService.QueryBreedsAsync(_breedLookup)).ToList();
        ...
        private async Task<Dictionary<string, AnimalTypeDto>> CollectAnimalTypes(List<Animal> animals, List<string> animalTypesFields)
        {
            ...
            // Κατασκευή των dtos
            List<AnimalTypeDto> animalTypeDtos = (await _animalTypeService.QueryAnimalTypesAsync(_animalTypeLookup)).ToList();
