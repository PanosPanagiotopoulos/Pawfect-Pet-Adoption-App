...
using Main_API.Services.AnimalTypeServices;
...
namespace Pawfect_Pet_Adoption_App_API.Controllers
{
    ...
    public class AnimalTypeController : ControllerBase
    {
        ...
        public async Task<IActionResult> QueryAnimalTypes([FromBody] AnimalTypeLookup animalTypeLookup)
        {
            ...
            List<Main_API.Data.Entities.AnimalType> datas = await q.CollectAsync();
            ...
            if (models == null) throw new NotFoundException("AnimalTypes not found", JsonHelper.SerializeObjectFormatted(animalTypeLookup), typeof(Main_API.Data.Entities.AnimalType));
        ...
        public async Task<IActionResult> GetAnimalType(String id, [FromQuery] List<String> fields)
        {
            ...
            if (model == null) throw new NotFoundException("AnimalType not found", JsonHelper.SerializeObjectFormatted(lookup), typeof(Main_API.Data.Entities.AnimalType));

            return Ok(model);
        }

        /// <summary>
        /// Persist an AnimalType.
        /// </summary>
        [HttpPost("persist")]
        [Authorize]
        [ServiceFilter(typeof(MongoTransactionFilter))]
        ...
        public async Task<IActionResult> DeleteMany([FromBody] List<String> ids)
        {
            ...
            await _animalTypeService.Delete(ids);
