...
namespace Pawfect_Messenger.Middlewares
{
    public class RateLimitingMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            (RateLimitLevel Level, RateLimitTier Tier, String CustomKey)? rateLimitInfo = GetRateLimitInfo(endpoint);
            ...
            String rateLimitKey = GenerateRateLimitKey(clientId, rateLimitInfo.Value.CustomKey ?? endpoint.DisplayName);
        ...
        private Boolean ShouldSkipRateLimit(HttpContext context)
        {
        ...
        private async Task<Boolean> IsRequestAllowed(String key, RateLimitTier tier)
        {
            if (!tier.Enabled)
                return true;
