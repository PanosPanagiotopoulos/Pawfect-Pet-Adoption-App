...
import { GifComponent, GifComponentConfig } from 'src/app/common/ui/gif.component';
  ...
  export class LoadingComponent implements OnInit, OnDestroy {
    ...
    onGifError(event: Event): void {
      ...
      if (this.currentGifIndex < this.gifSources.length) {
        ...
        this.currentGifSrc = this.addCacheBuster(this.gifSources[this.currentGifIndex]);
        this.gifError = false;
      } else {
